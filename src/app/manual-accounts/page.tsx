...
import { Loader2, Users, Trash2, ToggleLeft, ToggleRight, UserPlus, KeyRound, Edit, Film, Video, CreditCard, MicVocal, Calendar as CalendarIcon, Mail, MessageSquare, Copy, Check, RefreshCw } from 'lucide-react';
...
export default function ManualAccountsPage() {
    ...
    const [newlyCreatedUser, setNewlyCreatedUser] = useState<{email: string, password: string, plan: UserProfile['plan'], expiry?: Date, credits: number, receiptUrl?: string, whatsapp?: string} | null>(null);
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            if (result === 'timeout') {
                toast({ title: 'Data Fetch Timed Out', description: 'Displaying empty list as fallback.', variant: 'destructive' });
                setUsers([]);
            } else {
    ...
    useEffect(() => {
        ...
        // Only run if email is in params and we haven't run this yet.
        if (email && !hasAutoGenerated.current) {
            hasAutoGenerated.current = true;

            // 1. Pre-fill form from URL
            setNewUserEmail(email);
            setNewUserWhatsapp(searchParams.get('whatsapp') || '');
            setReceiptUrl(searchParams.get('receiptUrl') || '');
            const planFromUrl = searchParams.get('plan');
            if (planFromUrl) {
                setNewPlan(planFromUrl as UserProfile['plan']);
            }
            ...
            setNewDisplayName(newGuestName);
    ...
    const handleCreateUser = async () => {
        ...
        try {
            ...
            await AuthService.createUser(auth, db, {
                ...
                wallet: { credits: newUserCredits, spent: 0 },
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="font-headline text-3xl flex items-center justify-between">
                            <div className="flex items-center gap-2"><Users/> Manual Account Management</div>
                                ...
                                <DialogContent className="max-h-[90vh] overflow-y-auto">
                                    ...
                                    <div className="grid gap-4 py-4">
                                        <div className="grid gap-2">
                                            <Label htmlFor="new-name">Username</Label>
                                            <Input id="new-name" value={newDisplayName} readOnly disabled={isCreatingUser} />
                                        </div>
                                        <div className="grid gap-2">
                                         ...
                                         <div className="grid gap-2">
                                            ...
                                            <Input id="new-whatsapp" type="tel" value={newUserWhatsapp} onChange={e => setNewUserWhatsapp(e.target.value)} disabled={isCreatingUser} />
                                        </div>
                                        <div className="grid gap-2">
                                            <Label htmlFor="new-password">Generated Password</Label>
                                            <Input id="new-password" type="text" value={newUserPassword} readOnly disabled={isCreatingUser} />
                                        </div>
                        ...
                        <CardDescription>Review and manage manually created accounts or add new ones.</CardDescription>
                    </CardHeader>
                </Card>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {isLoadingData ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={7} className="h-24 text-center">No manual accounts yet.</TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        </Table>
                        ...
                        <>
                            ...
                            <DialogFooter className="flex-col sm:flex-row gap-2 sm:justify-between">
                                ...
                                <div className="flex justify-end gap-2 w-full sm:w-auto">
                                    ...
                                    {newlyCreatedUser.whatsapp && (
                                        <Button asChild>
                                            <a href={`https://wa.me/${newlyCreatedUser.whatsapp}?text=${encodeURIComponent(messageBody)}`} target="_blank">
